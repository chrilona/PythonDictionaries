...
#Random out of topic question
x=[x for x in range(2)]  #x=[0,1]
y=[y for y in range(5)if y%2==1] #y=[0,1,2,3,4]  if y%2==1 y=[1,3]
z=[(x,y)for x,y in zip(x,y)] #zip(x,y) #z=[(x,y)]
print(z)  #z=[(0,1),(1,3)]
